...
class HospitalDoctorsCard extends Component {
    ...
    render () {
        return (
            <div className={classes.card} style={{width: "20rem", height: "27rem"}}>
                <img src={'http://de70-103-61-113-219.ngrok.io' + this.props.doctorData.image} style={{width: "19.9rem", height: "16rem"}} className="card-img-top" alt="Hospital-Image"/>
